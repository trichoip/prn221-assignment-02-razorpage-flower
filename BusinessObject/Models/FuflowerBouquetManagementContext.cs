...
public partial class FuflowerBouquetManagementContext : DbContext
{
    ...
    public virtual DbSet<BusinessObject.Models.FlowerBouquet> FlowerBouquets { get; set; } = default!;

    public virtual DbSet<BusinessObject.Models.Customer>? Customers { get; set; }

    public virtual DbSet<BusinessObject.Models.Category>? Categories { get; set; }

    public virtual DbSet<BusinessObject.Models.Order>? Orders { get; set; }

    public virtual DbSet<BusinessObject.Models.OrderDetail>? OrderDetails { get; set; }

    public virtual DbSet<BusinessObject.Models.Supplier>? Suppliers { get; set; }
