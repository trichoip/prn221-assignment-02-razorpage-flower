USE [master]
GO
/****** Object:  Database [FUFlowerBouquetManagement]    Script Date: 11/06/2023 8:43:16 PM ******/
CREATE DATABASE [FUFlowerBouquetManagement]
GO
ALTER DATABASE [FUFlowerBouquetManagement] SET COMPATIBILITY_LEVEL = 150
GO
...
GO
ALTER DATABASE [FUFlowerBouquetManagement] SET AUTO_CLOSE OFF 
GO
...
GO
ALTER DATABASE [FUFlowerBouquetManagement] SET RECOVERY FULL 
GO
...
GO
EXEC sys.sp_db_vardecimal_storage_format N'FUFlowerBouquetManagement', N'ON'
GO
ALTER DATABASE [FUFlowerBouquetManagement] SET QUERY_STORE = OFF
GO
USE [FUFlowerBouquetManagement]
GO
/****** Object:  Table [dbo].[Category]    Script Date: 11/06/2023 8:43:16 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 11/06/2023 8:43:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FlowerBouquet]    Script Date: 11/06/2023 8:43:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Order]    Script Date: 11/06/2023 8:43:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderDetail]    Script Date: 11/06/2023 8:43:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Supplier]    Script Date: 11/06/2023 8:43:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
